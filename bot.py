...
SHOP_TAP = [
    {'bonus': 0.0001, 'price': 50,    'mult': 2.0, 'label': 'Коготь I'},
    {'bonus': 0.0002, 'price': 200,   'mult': 2.0, 'label': 'Коготь II'},
    {'bonus': 0.0005, 'price': 700,   'mult': 2.0, 'label': 'Коготь III'},
    {'bonus': 0.001,  'price': 2500,  'mult': 2.0, 'label': 'Коготь IV'},
    {'bonus': 0.002,  'price': 8000,  'mult': 2.0, 'label': 'Коготь V'},
]
SHOP_SEC = [
    {'bonus': 0.00005, 'price': 40,   'mult': 2.0, 'label': 'Авто I'},
    {'bonus': 0.0001,  'price': 150,  'mult': 2.0, 'label': 'Авто II'},
    {'bonus': 0.0002,  'price': 600,  'mult': 2.0, 'label': 'Авто III'},
    {'bonus': 0.0005,  'price': 2200, 'mult': 2.0, 'label': 'Авто IV'},
    {'bonus': 0.001,   'price': 7000, 'mult': 2.0, 'label': 'Авто V'},
]

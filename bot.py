...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8855914337:AAGA_gd5rL2ZbdIDNHRF_QR2ibU7ShIG-4w")
...
async def start(message: types.Message):
    ...
    WEBAPP_URL = "https://tapix1.onrender.com"  # <--- ПРАВИЛЬНАЯ ССЫЛКА
...
async def show_referral(callback: types.CallbackQuery):
    ...
    if user:
        code = user[6]
        await callback.message.answer(f"👥 Твоя ссылка: https://t.me/TapiX1_bot?start={code}")
